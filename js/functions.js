//By GACB (Phone Numbrer 571+ 3005790114)
function pop_up(div){
    $(div).bPopup({
		speed: 650,
		transition: 'fadeIn'	
...
function parallax(){
    ...
    prlx_lyr_1_2.style.top = (window.pageYOffset / 2)+'px';
	prlx_lyr_2.style.top = (window.pageYOffset / 3)+'px';
    prlx_lyr_2_2.style.top = (window.pageYOffset / 3)+'px';
    prlx_lyr_3.style.top = (window.pageYOffset / 25)+'px';
    prlx_lyr_4.style.top = (window.pageYOffset / 6)+'px';
    prlx_lyr_5.style.top = (window.pageYOffset / 5)+'px';
    ...
    prlx_lyr_8.style.left = (window.pageYOffset / 5)+'px';
    prlx_lyr_9.style.right = (window.pageYOffset / 0.5)+'px';
